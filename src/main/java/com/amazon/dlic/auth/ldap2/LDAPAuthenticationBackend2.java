...
public class LDAPAuthenticationBackend2 implements AuthenticationBackend, Destroyable {
    ...
    private final WildcardMatcher whitelistedAttributesMatcher;
    ...
    private User authenticate0(final AuthCredentials credentials) throws ElasticsearchSecurityException {
        ...
        try {
            ...
            return new LdapUser(username, user, entry, credentials, customAttrMaxValueLen, whitelistedAttributesMatcher);
    ...
    private boolean exists0(final User user) {
        ...
        try {
            ...
            if(exists) {
                user.addAttributes(LdapUser.extractLdapAttributes(userName, userEntry, customAttrMaxValueLen, whitelistedAttributesMatcher));
            }
